...
public final class Messages {
    ...
    public static final Map<String, String> EN = Map.ofEntries(
            ...
            Map.entry("home.description", "The name derives from Greek pan (all) and optikon (vision) — \"all-seeing\". The idea of the panopticum is a single vantage point from which the entire controlled space is visible. Here it is a tool for viewing and managing database connections — MongoDB, PostgreSQL, Redis, ClickHouse, MySQL, Cassandra — from one place."),
