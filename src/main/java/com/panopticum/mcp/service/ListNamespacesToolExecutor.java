...
public class ListNamespacesToolExecutor implements McpToolExecutor {
    ...
    public McpToolResponse execute(McpToolRequest request) {
        ...
        Map<String, Object> result = metadataFacadeService.listNamespaces(connectionId, catalog, page, size, sort, order);
